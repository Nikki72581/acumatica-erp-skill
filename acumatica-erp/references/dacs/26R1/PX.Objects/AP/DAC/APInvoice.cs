...
namespace PX.Objects.AP
{
	public class APInvoiceType : APDocType
	{
		...
		public class NumberingAttribute : AutoNumberAttribute
		{
            private static string[] _DocTypes
            {
                get
                {
                    return new string[] { Invoice, CreditAdj, DebitAdj, Prepayment, PrepaymentInvoice };
                }
            }
            ...
            {
				if (docType == Prepayment && PXAccess.FeatureInstalled<FeaturesSet.vATRecognitionOnPrepaymentsAP>())
				{
					// If the feature is turned on we prohibit to create new Prepayments on APInvoiceEntry screen.
					// This functionality is implememted in a separate AutoNumber class in extenstion.
					// But some screens explicitely use this static method to get numbering information, so it is
					// necessary to modify it also.
					return null;
				}
			...
			public NumberingAttribute(string[] docTypes, Type[] setupFields)
				: base(typeof(APInvoice.docType), typeof(APInvoice.docDate), docTypes, setupFields)
			{
			}

			public NumberingAttribute()
				: this(_DocTypes, _SetupFields)
            {
            }
		}

		public new static readonly string[] Values = { Invoice, CreditAdj, DebitAdj, Prepayment, PrepaymentInvoice };
		public new static readonly string[] Labels = { Messages.Invoice, Messages.CreditAdj, Messages.DebitAdj, Messages.Prepayment, Messages.PrepaymentInvoice };
		...
		public class TaxInvoiceListAttribute : PXStringListAttribute
		{
			public TaxInvoiceListAttribute()
				: base(
				new string[] { Invoice, CreditAdj, DebitAdj, PrepaymentInvoice },
				new string[] { Messages.Invoice, Messages.CreditAdj, Messages.DebitAdj, Messages.PrepaymentInvoice }) { }
		}
	...
	public class APPaymentBy 
	{
		...
		public class dueDate() : PX.Data.BQL.BqlInt.Constant<dueDate>(DueDate);
		public class discountDate() : PX.Data.BQL.BqlInt.Constant<discountDate>(DiscountDate);
	...
	public class APInvoice : APRegister, CM.IInvoice, IProjectTaxes, IAssign, IApprovable
	{
		#region Keys
		...
		#endregion
		#region Events
		public new class Events : PXEntityEvent<APInvoice>.Container<Events>
		{
        ...
        public new abstract class prepaymentAccountID : PX.Data.BQL.BqlDecimal.Field<prepaymentAccountID> { }
		#endregion
		#region prepaymentSubID
        public new abstract class prepaymentSubID : PX.Data.BQL.BqlDecimal.Field<prepaymentSubID> { }
		#endregion
		#region TermsID
        ...
        /// </summary>
		[PXDBCurrency(typeof(APInvoice.curyInfoID), typeof(APInvoice.taxTotal), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
        ...
        /// </summary>
		[PXDBDecimal(4, SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		[PXDBCurrency(typeof(APInvoice.curyInfoID), typeof(APInvoice.taxAmt), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		...
		[PXRestrictor(typeof(Where<PaymentMethod.paymentType, NotEqual<PaymentMethodType.externalPaymentProcessor>,
			Or<Where<PaymentMethod.paymentType, Equal<PaymentMethodType.externalPaymentProcessor>,
				And<FeatureInstalled<FeaturesSet.paymentProcessor>>>>>),
		...
		/// </summary>
		[PXDefault(typeof(Search2<Location.cAvalaraExemptionNumber,
			InnerJoin<BAccountR, On<BAccountR.bAccountID, Equal<Location.bAccountID>, And<BAccountR.defLocationID, Equal<Location.locationID>>>,
			InnerJoin<Branch, On<Branch.bAccountID, Equal<BAccountR.bAccountID>>>>,
			Where<Branch.branchID, Equal<Current<branchID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		[PXDBString(30, IsUnicode = true)]
		[PXUIField(DisplayName = "Tax Exemption Number")]
		public virtual string ExternalTaxExemptionNumber
		{
			get;
			set;
		}
		#endregion
		#region EntityUsageType
		public abstract class entityUsageType : PX.Data.BQL.BqlString.Field<entityUsageType> { }
		...
		/// Defaults to the <see cref="APInvoice.BranchID">Tax Exemption Type</see>
		/// that is specified for the <see cref="APInvoice.BranchID">location of the branch</see>.
		/// </value>
		[PXDefault(
			TXAvalaraCustomerUsageType.Default,
			typeof(Search2<Location.cAvalaraCustomerUsageType,
			InnerJoin<BAccountR, On<BAccountR.bAccountID, Equal<Location.bAccountID>, And<BAccountR.defLocationID, Equal<Location.locationID>>>,
			InnerJoin<Branch, On<Branch.bAccountID, Equal<BAccountR.bAccountID>>>>,
		...
		public virtual String EntityUsageType
		{
			get;
			set;
		}
...
namespace PX.Objects.AP.Standalone
{
	...
	public partial class APInvoice : PXBqlTable, PX.Data.IBqlTable
	{
		#region DocType
