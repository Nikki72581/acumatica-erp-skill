...
namespace PX.Objects.AP
{
	public class APDocStatus
	{
		...
		public class printed() : PX.Data.BQL.BqlString.Constant<printed>(Printed);

		public class prebooked() : PX.Data.BQL.BqlString.Constant<prebooked>(Prebooked);
		...
		public class underReclassification() : PX.Data.BQL.BqlString.Constant<underReclassification>(UnderReclassification);
	...
	public partial class APAROrd : PXBqlTable, PX.Data.IBqlTable
	{
		#region Ord
	...
	public partial class APRegister : PXBqlTable, IBqlTable, IRegister, IBalance, IProjectHeader, IDocumentKey, INotable
	{
		#region Keys
		...
		/// should be posted when the feature <see cref="FeaturesSet.VATRecognitionOnPrepaymentsAP"/> is activated.
		...
		[Account(typeof(APRegister.branchID), typeof(Search<Account.accountID,
			...
			DisplayName = "Prepayment Account", ControlAccountForModule = ControlAccountModule.AP)]
		...
		/// </value>
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		[SubAccount(typeof(APRegister.prepaymentAccountID), DescriptionField = typeof(Sub.description), DisplayName = "Prepayment Subaccount", Visibility = PXUIVisibility.Visible)]
		...
		[PXDBCurrency(typeof(APRegister.curyInfoID), typeof(APRegister.origDocAmt), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		...
		/// </summary>
		[PXDBBaseCury(typeof(branchID), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		[PXDefault(TypeCode.Decimal, "0.0")]
		[DynamicLabel(typeof(
			labelUnpaidBalance.When<APRegister.docType.IsEqual<APDocType.prepaymentInvoice>
				.And<APRegister.status.IsNotEqual<APDocStatus.unapplied>>
				.And<APRegister.status.IsNotEqual<APDocStatus.closed>>
				.And<APRegister.status.IsNotEqual<APDocStatus.voided>>
				.And<APRegister.status.IsNotEqual<APDocStatus.reserved>>
			>
			.Else<labelBalance>
		))]
		[PXDBCurrency(typeof(APRegister.curyInfoID), typeof(APRegister.docBal), BaseCalc = false, SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		...
		/// </summary>
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBCurrency(typeof(APRegister.curyInfoID), typeof(APRegister.initDocBal), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		[PXUIField(DisplayName = "Balance", Visibility = PXUIVisibility.SelectorVisible, Enabled = false)]
		...
		/// </summary>
		[PXDBBaseCury(SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		/// </summary>
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBCurrency(typeof(APRegister.curyInfoID), typeof(APRegister.origDiscAmt), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		...
		[PXDependsOnFields(
			...
			typeof(APRegister.pendingProcessing))]
		...
		public class SetStatusAttribute : PXEventSubscriberAttribute, IPXRowUpdatingSubscriber, IPXRowInsertingSubscriber
		{
			...
			protected virtual void StatusSet(PXCache cache, APRegister item, bool? HoldVal)
			{
				...
				{
					item.Status = item.DocType == APDocType.PrepaymentInvoice
		...
		#region HasMultipleProjects

		public abstract class hasMultipleProjects : BqlBool.Field<hasMultipleProjects> {}
		...
		[PXDBCurrency(typeof(APRegister.curyInfoID), typeof(APRegister.retainageTotal), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		...
		[PXDBCurrency(typeof(APRegister.curyInfoID), typeof(APRegister.retainageUnreleasedAmt), SignCondition = typeof(APDocType.PositiveAmountTypes.Contains<docType>))]
		...
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		// This formula is copied to calculate Total Amount column in AP3010PL generic inquiry.
		// Please, update the inquiry as well, when updating the formula
		...
		/// when the feature <see cref="FeaturesSet.VATRecognitionOnPrepaymentsAP"/> is activated.
		/// </summary>
		[PXDBBool]
		[PXDefault(false)]
		...
		#region IsExpectedPPVValid
		/// <summary>
		/// Indicates that related <see cref="APTran.ExpectedPPVAmount"/> contains an actual values.
		/// If value is false, the <see cref="APTran.ExpectedPPVAmount"/> values will be recalculated during the document saving.
		/// </summary>
		[PXDBBool]
		[PXDefault(false)]
		public virtual bool? IsExpectedPPVValid { get; set; }
		public abstract class isExpectedPPVValid : PX.Data.BQL.BqlBool.Field<isExpectedPPVValid> { }
		#endregion
	...
	public partial class APRegisterReport : APRegister
	{
		...
		/// <inheritdoc cref="APRegister.RefNbr"/>
		[PXDBString(15, IsUnicode = true, IsKey = true, InputMask = "")]
		[PXDefault]
		[PXUIField(DisplayName = "Reference Nbr.", Visibility = PXUIVisibility.SelectorVisible, TabOrder = 1)]
		[PXSelector(typeof(Search<APRegisterReport.refNbr, Where<APRegisterReport.docType, Equal<Optional<APRegisterReport.docType>>>>), Filterable = true)]
		...
		public new abstract class hasMultipleProjects : PX.Data.BQL.BqlBool.Field<hasMultipleProjects> {}
		...
		[PXDependsOnFields(typeof(docType))]
		[PXFormula(typeof(
				Case<Where<APRegister.docType.IsIn<APDocType.refund, APDocType.voidRefund, APDocType.invoice, APDocType.prepaymentInvoice, APDocType.creditAdj>>, decimal1,
	...
	public class APRegisterP : PXBqlTable, IBqlTable
	{
		#region OrigModule
		public abstract class origModule : PX.Data.BQL.BqlString.Field<origModule> { }
		protected String _OrigModule;
	...
	public partial class APAdjustedBalanceAtDate : PXBqlTable, IBqlTable
	{
		public abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
	...
	public partial class APAdjustingBalanceAtDate : PXBqlTable, IBqlTable
	{
		public abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
	...
	public partial class APInvoiceRetainageBalanceAtDate : PXBqlTable, IBqlTable
	{
		public abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
	...
	public partial class APRegisterRetainage : PXBqlTable, PX.Data.IBqlTable
	{
		public abstract class origDocType : PX.Data.BQL.BqlString.Field<origDocType> { }
	...
	public partial class APTranRetainage : PXBqlTable, PX.Data.IBqlTable
	{
		public abstract class origDocType : PX.Data.BQL.BqlString.Field<origDocType> { }
	...
	[PXProjection(typeof(Select<APRegister>))]
	[PXHidden]
	public class APRegisterOrigRetainage : PXBqlTable, IBqlTable
	{
		public abstract class retainageApply : PX.Data.BQL.BqlBool.Field<retainageApply> { }
