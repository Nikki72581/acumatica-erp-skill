...
namespace PX.Objects.AP
{
	...
	public partial class Vendor : CR.BAccount, PX.SM.IIncludable
	{
		...
		[PXDefault(typeof(Select<VendorClass, Where<VendorClass.vendorClassID, Equal<Current<Vendor.vendorClassID>>>>), SourceField = typeof(VendorClass.discTakenAcctID), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[SubAccount(typeof(Vendor.discTakenAcctID), DisplayName = "Cash Discount Sub.", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Sub.description), Required = true)]
		[PXDefault(typeof(Select<VendorClass, Where<VendorClass.vendorClassID, Equal<Current<Vendor.vendorClassID>>>>), SourceField = typeof(VendorClass.discTakenSubID), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class tinType : PX.Data.BQL.BqlString.Field<tinType>
		{
			...
			public class eIN() : PX.Data.BQL.BqlString.Constant<eIN>(EIN);
			public class sSN() : PX.Data.BQL.BqlString.Constant<sSN>(SSN);
			public class iTIN() : PX.Data.BQL.BqlString.Constant<iTIN>(ITIN);
			public class aTIN() : PX.Data.BQL.BqlString.Constant<aTIN>(ATIN);
		}
		[PXDBString(1, IsFixed = true)]
		...
		[PXSearchable(SM.SearchCategory.AP | SM.SearchCategory.PO | SM.SearchCategory.AR | SM.SearchCategory.SO | SM.SearchCategory.CR, Messages.SearchableTitleVendor, new Type[] { typeof(Vendor.acctName) },
		   new Type[] { typeof(Vendor.acctName), typeof(Vendor.acctCD), typeof(Vendor.acctName), typeof(Vendor.acctCD), typeof(Vendor.defContactID), typeof(Contact.displayName), typeof(Contact.eMail), typeof(Contact.phone1), typeof(Contact.phone2), typeof(Contact.phone3), typeof(Contact.webSite),
						typeof(Vendor.defAddressID), typeof(Address.displayName)},
			...
			SelectForFastIndexing = typeof(Select2<Vendor, InnerJoin<Contact, On<Contact.contactID, Equal<Vendor.defContactID>>, InnerJoin<Address, On<Address.addressID, Equal<Vendor.defAddressID>>>>>),
	...
	public class VendorStatus
	{
		...
		public class holdPayments() : PX.Data.BQL.BqlString.Constant<holdPayments>(HoldPayments);
	...
	/// <summary>
	/// Extension is need to force set <see cref="Vendor.ClassID"/> even if there is some extension for <see cref="BAccount.ClassID"/> over <see cref="BAccount"/>
	/// which will override attributes even for <see cref="Vendor"/>.
	/// </summary>
	[PXInternalUseOnly]
	public sealed class VendorClassIDExt : PXCacheExtension<Vendor>
	{
		...
		public string ClassID => Base.VendorClassID;
	}
}
