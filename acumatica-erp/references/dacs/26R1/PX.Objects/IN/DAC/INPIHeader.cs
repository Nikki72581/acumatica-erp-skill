...
namespace PX.Objects.IN
{
	...
	public partial class INPIHeader : PXBqlTable, IBqlTable
	{
		#region Keys
		public class PK : PrimaryKeyOf<INPIHeader>.By<pIID>
		{
			public static INPIHeader Find(PXGraph graph, string pIID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, pIID, options);
		}
		...
		[PXFormula(typeof(Selector<siteID, INSite.baseCuryID>))]
	...
	public class INPIHdrStatus
	{
		...
		public class counting() : BqlString.Constant<counting>(Counting);
		public class entering() : BqlString.Constant<entering>(Entering);
		public class onReview() : BqlString.Constant<onReview>(InReview);
		public class completed() : BqlString.Constant<completed>(Completed);
		public class cancelled() : BqlString.Constant<cancelled>(Cancelled);
	}
}
