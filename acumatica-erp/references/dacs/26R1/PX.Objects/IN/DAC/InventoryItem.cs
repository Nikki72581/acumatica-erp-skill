...
namespace PX.Objects.IN
{
	...
	/// Whether the item is a stock item or a non-stock item is determined by the value of the <see cref="StkItem"/> field.
	/// The records of this type are created and edited on the Stock Items (IN202500) form
	/// (which corresponds to the <see cref="InventoryItemMaint"/> graph) and
	/// the Non-Stock Items (IN202000) form (which corresponds to the <see cref="NonStockItemMaint"/> graph).
	/// </summary>
	[PXPrimaryGraph(
		new Type[] {
	...
	public class InventoryItem : PXBqlTable, IBqlTable, PX.SM.IIncludable
	{
		#region Keys
		public class PK : PrimaryKeyOf<InventoryItem>.By<inventoryID>
		{
			public static InventoryItem Find(PXGraph graph, int? inventoryID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryID, options);
		...
		{
			public static InventoryItem Find(PXGraph graph, string inventoryCD, PKFindOptions options = PKFindOptions.None) => FindBy(graph, inventoryCD, options);
		}
		...
		#endregion
		#region IsConverted
		public abstract class isConverted : BqlBool.Field<isConverted> { }
		[PXUIField(DisplayName = "Is Converted")]
		[PXDBBool]
		[PXDefault(false)]
		public virtual bool? IsConverted
		{
			get;
			set;
		}
		#endregion
		#region IsConversionMode
		public abstract class isConversionMode : BqlBool.Field<isConversionMode> { }
		[PXBool]
		public virtual bool? IsConversionMode
		{
			get;
			set;
		}
		...
		public abstract class baseUnit : BqlString.Field<baseUnit>
		{
				...
				where TSelect : BqlCommand, new()
			{
				...
				{
					firstPreventingEntity = PXResult.UnwrapMain(firstPreventingEntity);
		...
		{
			/// <exclude/>
			public class WarnIfNonZeroCostLayerExists : WarnIfNonZeroCostLayerExists<invtAcctID, InventoryItemMaint>
			{
		...
		[PXFormula(typeof(Use<Selector<InventoryItem.postClassID, INPostClass.stdCstRevAcctID>>.AsInt.When<InventoryItem.stkItem.IsEqual<True>>.Else<Null>))]
		...
		[PXFormula(typeof(Use<Selector<InventoryItem.postClassID, INPostClass.stdCstRevSubID>>.AsInt.When<InventoryItem.stkItem.IsEqual<True>>.Else<Null>))]
		...
		[PXFormula(typeof(Use<Selector<InventoryItem.postClassID, INPostClass.stdCstVarAcctID>>.AsInt.When<InventoryItem.stkItem.IsEqual<True>>.Else<Null>))]
		...
		[PXFormula(typeof(Use<Selector<InventoryItem.postClassID, INPostClass.stdCstVarSubID>>.AsInt.When<InventoryItem.stkItem.IsEqual<True>>.Else<Null>))]
		...
		[PXFormula(typeof(Use<Selector<InventoryItem.postClassID, INPostClass.lCVarianceAcctID>>.AsInt.When<InventoryItem.stkItem.IsEqual<True>>.Else<Null>))]
		...
		[PXFormula(typeof(Use<Selector<InventoryItem.postClassID, INPostClass.lCVarianceSubID>>.AsInt.When<InventoryItem.stkItem.IsEqual<True>>.Else<Null>))]
		...
		/// </value>
		[AP.VendorNonEmployeeActiveOrHoldPayments(DisplayName = "Preferred Vendor", Required = false, DescriptionField = typeof(AP.Vendor.acctName))]
		...
		/// Defaults to the <see cref="INItemClassCurySettings.DfltSiteID">Default Warehouse</see> specified for the <see cref="ItemClassID">Class of the item</see>.
		/// </value>
		...
		#endregion
		#region DefaultCostCodeID
		public abstract class defaultCostCodeID : PX.Data.BQL.BqlInt.Field<defaultCostCodeID> { }

		/// <summary>The default cost code of the item.</summary>
		[PXDBInt]
		[PXForeignReference(typeof(Field<defaultCostCodeID>.IsRelatedTo<PMCostCode.costCodeID>))]
		[PXUIField(DisplayName = "Default Cost Code", FieldClass = CostCodeAttribute.COSTCODE, Visibility = PXUIVisibility.SelectorVisible)]
		...
		public virtual Int32? DefaultCostCodeID
		{
			get;
			set;
		}
		...
		#endregion
		#region OrigLotSerClassID
		[PXString]
		[PXDBCalced(typeof(lotSerClassID), typeof(string), Persistent = true)]
		public virtual string OrigLotSerClassID { get; set; }
		public abstract class origLotSerClassID : BqlString.Field<origLotSerClassID> { }
		#endregion
		...
		#endregion
		#region PostToExpenseAccount
		/// <summary>
		/// When set to Sales, indicates that cost will be processed using expense accrual account.
		/// </summary>
		[PXDBString]
		[postToExpenseAccount.List]
		[PXUIField(DisplayName = "Post Cost to Expenses On")]
		[PXUIEnabled(typeof(Where<kitItem.IsNotEqual<True>>))]
		[PXDefault(postToExpenseAccount.Purchases, typeof(SelectParentItemClass), SourceField = typeof(INItemClass.postToExpenseAccount), CacheGlobal = true)]
		public virtual string PostToExpenseAccount { get; set; }
		public abstract class postToExpenseAccount : PX.Data.BQL.BqlString.Field<postToExpenseAccount>
		{
			public const string Purchases = "P";
			public const string Sales = "S";

			public class purchases() : BqlString.Constant<purchases>(Purchases);
			public class sales() : BqlString.Constant<sales>(Sales);

			public class ListAttribute : PXStringListAttribute
			{
				public ListAttribute() : base(
					Pair(Purchases, DisplayName.Purchases),
					Pair(Sales, DisplayName.Sales))
				{ }
			}
		...
		[PXUIEnabled(typeof(Where<postToExpenseAccount.IsEqual<postToExpenseAccount.sales>.And<kitItem.IsNotEqual<True>>>))]
		...
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBDecimal(6, MinValue = 0, MaxValue = 1000)]
		[PXUIEnabled(typeof(Where<postToExpenseAccount.IsEqual<postToExpenseAccount.sales>.And<costBasis.IsEqual<CostBasisOption.percentOfSalesPrice>>>))]
		...
		#region PreferredItemClasses
		public abstract class preferredItemClasses : BqlString.Field<preferredItemClasses> { }

		/// <exclude/>
		[PXDBString(1, IsFixed = true, IsUnicode = false)]
		[PXDefault(PreferredItemClassesList.AllClasses, typeof(SelectParentItemClass), SourceField = typeof(INItemClass.preferredItemClasses))]
		[PXUIField(DisplayName = "Preferred Item Classes", FieldClass = nameof(FeaturesSet.RelatedItemAssistant))]
		[PreferredItemClassesList.List]
		public virtual string PreferredItemClasses
		{
			get;
			set;
		}
		...
		#region PriceOfSuggestedItems
		public abstract class priceOfSuggestedItems : BqlString.Field<priceOfSuggestedItems> { }

		/// <exclude/>
		[PXDBString(1, IsFixed = true, IsUnicode = false)]
		[PXDefault(PriceOfSuggestedItemsList.AnyPrice, typeof(SelectParentItemClass), SourceField = typeof(INItemClass.priceOfSuggestedItems))]
		[PXUIField(DisplayName = "Price Of Suggested Items", FieldClass = nameof(FeaturesSet.RelatedItemAssistant))]
		[PriceOfSuggestedItemsList.List]
		public virtual string PriceOfSuggestedItems
		{
			get;
			set;
		}
		...
		[PXAttachedFile(FileTypesCategory.Images)]
		public virtual String ImageUrl { get; set; }
		public abstract class imageUrl : BqlString.Field<imageUrl> { }
		#endregion

		#region Commodity Code Type
		[PXDBString(30, IsUnicode = true)]
		[PXDefault(typeof(SelectParentItemClass), SourceField = typeof(INItemClass.commodityCodeType), PersistingCheck = PXPersistingCheck.Nothing, CacheGlobal = true)]
		[PXUIField(DisplayName = "Commodity Code Type", Visibility = PXUIVisibility.SelectorVisible)]
		[CommodityCodeTypes.List]
		public virtual String CommodityCodeType { get; set; }
		public abstract class commodityCodeType : BqlString.Field<commodityCodeType> { }
		#endregion
		#region HSTariffCode
		[PXDBString(30, IsUnicode = true)]
		...
		#region DefaultInventorySourceForProjects
		public abstract class defaultInventorySourceForProjects : BqlString.Field<defaultInventorySourceForProjects> { }

		/// <summary>
		/// The default inventory source for projects.
		/// </summary>
		[PXDBString(1, IsFixed = true)]
		[PXDefault(PM.InventorySourceType.ProjectStock)]
		[PM.InventorySourceType.List]
		[PXUIField(DisplayName = "Default Inventory Source for Projects", FieldClass = nameof(FeaturesSet.MaterialManagement))]
		public virtual string DefaultInventorySourceForProjects
		{
			get;
			set;
		}
		...
		#endregion
		#region tstamp
		[PXDBTimestamp(VerifyTimestamp = VerifyTimestampOptions.BothFromGraphAndRecord, ForbidChangesOfPersistedRecords = true)]
		...
		[MatrixAttributeSelector(typeof(
			Search2<CSAnswers.attributeID,
			InnerJoin<CSAttributeGroup, On<CSAttributeGroup.attributeID.IsEqual<CSAnswers.attributeID>>>,
			Where<
				CSAnswers.refNoteID.IsEqual<noteID.FromCurrent>.
				And<CSAnswers.isActive.IsEqual<True>>.
				And<CSAttributeGroup.entityClassID.IsEqual<Use<parentItemClassID.FromCurrent>.AsString>>.
			...
			typeof(defaultColumnMatrixAttributeID), true, typeof(CSAttributeGroup.attributeID),
		...
		[MatrixAttributeSelector(typeof(
			...
			Where<
				...
				And<CSAttributeGroup.entityType.IsEqual<Constants.DACName<InventoryItem>>>.
				And<CSAttributeGroup.attributeCategory.IsEqual<CSAttributeGroup.attributeCategory.variant>>>>),
			typeof(defaultRowMatrixAttributeID), true, typeof(CSAttributeGroup.attributeID),
			DescriptionField = typeof(CSAttributeGroup.description), DirtyRead = true)]
		[PXRestrictor(typeof(Where<CSAttributeGroup.isActive, Equal<True>>), Messages.AttributeIsInactive, typeof(CSAttributeGroup.attributeID))]
		...
		#endregion
		#region AvailabilityAdjustment
		/// <summary>
		/// Value to adjust availability when exporting availability to external eStores.
		/// </summary>
		/// <example>If ERP has 200 items and user wants to display 190 in eStore, then <see cref="AvailabilityAdjustment"/> value should be set to -10.</example>
		[PXDBQuantity()]
		[PXUIField(DisplayName = "Availability Adjustment")]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public Decimal? AvailabilityAdjustment { get; set; }
		/// <inheritdoc cref="AvailabilityAdjustment"/>
		public abstract class availabilityAdjustment : BqlDecimal.Field<availabilityAdjustment> { }
		#endregion
		#region ExportToExternal
		public abstract class exportToExternal : BqlBool.Field<exportToExternal> { }
		protected bool? _ExportToExternal;
		[PXDBBool()]
		[PXUIField(DisplayName = "Export to External System", Visibility = PXUIVisibility.SelectorVisible)]
		...
		#endregion
		#region IsSpecialOrderItem
		public abstract class isSpecialOrderItem : BqlBool.Field<isSpecialOrderItem> { }
		[PXDBBool()]
		[PXUIField(DisplayName = "Special-Order Item", FieldClass = FeaturesSet.specialOrders.FieldClass)]
		[PXDefault(false)]
		public virtual Boolean? IsSpecialOrderItem
		{
			get;
			set;
		}
		...
		[PXDefault(INReplenishmentSource.Purchased, typeof(SelectParentItemClass), SourceField = typeof(INItemClass.replenishmentSource), CacheGlobal = true)]
		...
		[PXDefault(INPlanningMethod.None, typeof(SelectParentItemClass), SourceField = typeof(INItemClass.planningMethod), CacheGlobal = true)]
		...
		#endregion
		#region SOSource
		public abstract class sOSource : BqlString.Field<sOSource> { }

		/// <summary>
		/// The source for Sales Order, which defines default values for the <c>Mark for PO</c> field and the <c>PO Source</c> for sales order line.
		/// This field is displayed only if the <see cref="FeaturesSet.DropShipments"/> field or the <see cref="FeaturesSet.SOToPOLink"/> is set to <c>true</c>.
		/// </summary>
		/// <value>
		/// The field can have one of the following values:
		/// <c>"N"</c> (None): The Mark for PO checkbox should be cleared at the moment of line creation.
		/// <c>"D"</c> (Drop-Ship): The Mark for PO checkbox should be selected at the moment of line creation, and PO Source = Drop-Ship.
		/// <c>"O"</c> (Purchase to Order): The Mark for PO checkbox should be selected at the moment of line creation, and PO Source = Purchase to Order.
		/// </value>
		[PXDBString(1, IsFixed = true)]
		[PXDefault(INReplenishmentSource.None)]
		[PXUIField(DisplayName = "Source for Sales Order")]
		[INReplenishmentSource.SOSourceList()]
		public virtual string SOSource { get; set; }
		#endregion
	}
	...
	public class InventoryItemStatus
	{
		...
		public class active() : BqlString.Constant<active>(Active);
		public class noSales() : BqlString.Constant<noSales>(NoSales);
		public class noPurchases() : BqlString.Constant<noPurchases>(NoPurchases);
		public class noRequest() : BqlString.Constant<noRequest>(NoRequest);
		public class inactive() : BqlString.Constant<inactive>(Inactive);
		public class markedForDeletion() : BqlString.Constant<markedForDeletion>(MarkedForDeletion);
		public class unknown() : BqlString.Constant<unknown>(Unknown);
	}
	...
	public class CompletePOLineTypes
	{
		...
		public class amount() : BqlString.Constant<amount>(Amount);
		public class quantity() : BqlString.Constant<quantity>(Quantity);
	}
	...
	public class INItemTypes
	{
		...
		public class nonStockItem() : BqlString.Constant<nonStockItem>(NonStockItem);
		public class laborItem() : BqlString.Constant<laborItem>(LaborItem);
		public class serviceItem() : BqlString.Constant<serviceItem>(ServiceItem);
		public class chargeItem() : BqlString.Constant<chargeItem>(ChargeItem);
		public class expenseItem() : BqlString.Constant<expenseItem>(ExpenseItem);

		public class finishedGood() : BqlString.Constant<finishedGood>(FinishedGood);
		public class component() : BqlString.Constant<component>(Component);
		public class subAssembly() : BqlString.Constant<subAssembly>(SubAssembly);
	}
	...
	public class INValMethod
	{
		...
		public class standard() : BqlString.Constant<standard>(Standard);
		public class average() : BqlString.Constant<average>(Average);
		public class fIFO() : BqlString.Constant<fIFO>(FIFO);
		public class specific() : BqlString.Constant<specific>(Specific);
	}
	...
	public class INItemStatus
	{
		...
		public class noSales() : BqlString.Constant<noSales>(NoSales);
		public class noPurchases() : BqlString.Constant<noPurchases>(NoPurchases);
		public class toDelete() : BqlString.Constant<toDelete>(ToDelete);
	}
	...
	public class INPackageOption
	{
		...
		public class manual() : BqlString.Constant<manual>(Manual);
		public class weight() : BqlString.Constant<weight>(Weight);
		public class quantity() : BqlString.Constant<quantity>(Quantity);
		public class weightAndVolume() : BqlString.Constant<weightAndVolume>(WeightAndVolume);
	}
	...
	public class CostBasisOption
	{
		...
		public class standardCost() : BqlString.Constant<standardCost>(StandardCost);
		public class priceMarkupPercent() : BqlString.Constant<priceMarkupPercent>(PriceMarkupPercent);
		public class percentOfSalesPrice() : BqlString.Constant<percentOfSalesPrice>(PercentOfSalesPrice);
		public class undefinedCostBasis() : BqlString.Constant<undefinedCostBasis>(UndefinedCostBasis);
	}
	...
	public class CommodityCodeTypes
	{
		...
		public class StockCommodityCodeListAttribute : CustomListAttribute
		{
			public StockCommodityCodeListAttribute() : base(
				Pair(HSCode, HSCode),
				Pair(HTSCode, HTSCode),
				Pair(HSNCode, HSNCode),
				Pair(NCMCode, NCMCode),
				Pair(UNSPSCCode, UNSPSCCode))
			{ }
		}

		public class NonStockCommodityCodeListAttribute : CustomListAttribute
		{
			public NonStockCommodityCodeListAttribute() : base(
				Pair(HSCode, HSCode),
				Pair(HTSCode, HTSCode),
				Pair(HSNCode, HSNCode),
				Pair(NCMCode, NCMCode),
				Pair(UNSPSCCode, UNSPSCCode),
				Pair(ServiceCode, ServiceCode))
			{ }
		}
		...
		public class hSCode() : BqlString.Constant<hSCode>(HSCode);
		public class hTSCode() : BqlString.Constant<hTSCode>(HTSCode);
		public class hSNCode() : BqlString.Constant<hSNCode>(HSNCode);
		public class nCMCode() : BqlString.Constant<nCMCode>(NCMCode);
		public class uNSPSCCode() : BqlString.Constant<uNSPSCCode>(UNSPSCCode);
		public class serviceCode() : BqlString.Constant<serviceCode>(ServiceCode);
	...
	public class INPlanningMethod
	{
		public class List : PXStringListAttribute
		{
			public List() : base(
				new[]
				{
						...
						Pair(DRP, Messages.DRP),
						Pair(MRP, Messages.MRP),
						Pair(InventoryReplenishment, Messages.InventoryReplenishment)
				})
			{ }
		}
		...
		/// <summary>
		/// Contract level InventoryReplenishment
		/// </summary>
		public class inventoryReplenishment() : PX.Data.BQL.BqlString.Constant<inventoryReplenishment>(InventoryReplenishment);

		/// <summary>
		/// Contract level None
		/// </summary>
		public class none() : PX.Data.BQL.BqlString.Constant<none>(None);

		/// <summary>
		/// Contract level DRP
		/// </summary>
		public class dRP() : PX.Data.BQL.BqlString.Constant<dRP>(DRP);

		/// <summary>
		/// Contract level MRP
		/// </summary>
		public class mRP() : PX.Data.BQL.BqlString.Constant<mRP>(MRP);
	}
	...
	public class PreferredItemClassesList
	{
		...
		{
			public ListAttribute() : base(
				new string[] { AllClasses, SameClass, OtherClasses },
				new string[] { Messages.AllClasses, Messages.SameClass, Messages.OtherClasses })
			{ }
		}
	...
	public class PriceOfSuggestedItemsList
	{
		...
		{
			public ListAttribute() : base(
				new string[] { AnyPrice, LowerPrice},
				new string[] { Messages.AnyPrice, Messages.LowerPrice})
			{ }
		}
	...
	/// <summary>
	/// An alias for Matrix Item (<see cref="InventoryItem"/>) which can be used for building complex BQL queries.
	/// </summary>
	[PXHidden]
	public class TemplateChildInventoryItem : InventoryItem
	{
		...
		#endregion
		#region IsTemplate
		public new abstract class isTemplate : Data.BQL.BqlBool.Field<isTemplate> { }
		#endregion
		#region TemplateItemID
