...
namespace PX.Objects.IN
{
	...
	public partial class INPIDetail : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
		public class PK : PrimaryKeyOf<INPIDetail>.By<pIID, lineNbr>
		{
			public static INPIDetail Find(PXGraph graph, string pIID, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, pIID, lineNbr, options);
		}
		public static class FK
		{
			...
			public class LocationStatus : INLocationStatus.PK.ForeignKeyOf<INPIDetail>.By<inventoryID, subItemID, siteID, locationID> { }
			public class LotSerialStatus : INLotSerialStatus.PK.ForeignKeyOf<INPIDetail>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr> { }
		}
		#endregion
		#region PIID
	...
	public class INPIDetStatus
	{
		...
		public class notEntered() : PX.Data.BQL.BqlString.Constant<notEntered>(NotEntered);

		public class entered() : PX.Data.BQL.BqlString.Constant<entered>(Entered);

		public class skipped() : PX.Data.BQL.BqlString.Constant<skipped>(Skipped);
	}
	...
	public class INPIDetLineType
	{
		...
		public class normal() : PX.Data.BQL.BqlString.Constant<normal>(Normal);

		public class blank() : PX.Data.BQL.BqlString.Constant<blank>(Blank);

		public class userEntered() : PX.Data.BQL.BqlString.Constant<userEntered>(UserEntered);
	}
}
