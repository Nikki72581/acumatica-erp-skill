...
namespace PX.Objects.AR
{
	...
	public partial class CustomerMaster: PXBqlTable, IBqlTable
	{
		#region Keys
	...
	[PXProjection(typeof(Select<Customer>))]
	public partial class CustomerSharedCredit : PXBqlTable, IBqlTable
	{
		#region BAccountID
		public abstract class bAccountID : PX.Data.BQL.BqlInt.Field<bAccountID> { }
	...
	public partial class Customer : BAccount, PX.SM.IIncludable
	{
		...
		[PXDefault(typeof(Search<ARSetup.dfltCustomerClassID>))]
		[PXSelector(typeof(Search<CustomerClass.customerClassID, Where<MatchUser>>),
			CacheGlobal = true,
			DescriptionField = typeof(CustomerClass.descr))]
		[PXUIField(DisplayName = "Customer Class")]
		...
		/// </summary>
		[PXDefault(typeof(Search<CustomerClass.discTakenAcctID, Where<CustomerClass.customerClassID, Equal<Current<Customer.customerClassID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		[Account(DisplayName = "Cash Discount Account", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Account.description), AvoidControlAccounts = true, Required = true)]
		...
		/// cash discount taken by the customer.
		/// </summary>
		[PXDefault(typeof(Search<CustomerClass.discTakenSubID, Where<CustomerClass.customerClassID, Equal<Current<Customer.customerClassID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		[SubAccount(typeof(Customer.discTakenAcctID), DisplayName = "Cash Discount Sub.", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Sub.description), Required = true)]
		...
		/// </summary>
		[PXDBString(1, IsFixed = true)]
		[PXDefault(typeof(Search<CustomerClass.statementType, Where<CustomerClass.customerClassID, Equal<Current<Customer.customerClassID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		#region BAccountClassID
		public abstract class bAccountClassID : PX.Data.BQL.BqlString.Field<bAccountClassID> { }

		/// <summary>
		/// The <see cref="BAccount.classID"/> field, which is used for internal purposes.
		/// </summary>
		[PXDBString(10, IsUnicode = true, BqlField = typeof(BAccount.classID))]
		[PXUIField(DisplayName = "Business Account Class", Visible = false, FieldClass = FeaturesSet.customerModule.FieldClass)]
		...
		#region LocaleName
		public new abstract class localeName : PX.Data.BQL.BqlString.Field<localeName> { }
		/// <summary>
		...
		[PXUIVisible(typeof(FeatureInstalled<FeaturesSet.bigCommerceB2B>.Or<FeatureInstalled<FeaturesSet.shopifyB2B>>))]
		...
		#region IsECMValid
		public abstract class isECMValid : PX.Data.BQL.BqlBool.Field<isECMValid> { }
		/// <summary>
	...
	public class CustomerStatus
	{
		...
		public class prospect() : PX.Data.BQL.BqlString.Constant<prospect>(Prospect);
		public class active() : PX.Data.BQL.BqlString.Constant<active>(Active);
		...
		public class oneTime() : PX.Data.BQL.BqlString.Constant<oneTime>(OneTime);
		public class inactive() : PX.Data.BQL.BqlString.Constant<inactive>(Inactive);
	}
	...
	/// <summary>
	/// Extension is need to force set <see cref="Customer.ClassID"/> even if there is some extension for <see cref="BAccount.ClassID"/> over <see cref="BAccount"/>
	/// which will override attributes even for <see cref="Customer"/>.
	/// </summary>
	[PXInternalUseOnly]
	public sealed class CustomerClassIDExt : PXCacheExtension<Customer>
	{
		...
		public string ClassID => Base.CustomerClassID;
	}
}
