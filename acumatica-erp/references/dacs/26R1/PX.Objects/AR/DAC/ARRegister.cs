...
namespace PX.Objects.AR
{
	...
	public class ARDocStatus : ILabelProvider
	{
		private static readonly IEnumerable<ValueLabelPair> _valueLabelPairs = new ValueLabelList
		{
			...
			{ PendingPayment, Messages.PendingPayment },
			{ Unapplied, Messages.Unapplied },
		};
		...
		public class incomplete() : PX.Data.BQL.BqlString.Constant<incomplete>(Incomplete);

		public class hold() : PX.Data.BQL.BqlString.Constant<hold>(Hold);

		public class balanced() : PX.Data.BQL.BqlString.Constant<balanced>(Balanced);

		public class voided() : PX.Data.BQL.BqlString.Constant<voided>(Voided);

		public class scheduled() : PX.Data.BQL.BqlString.Constant<scheduled>(Scheduled);

		public class open() : PX.Data.BQL.BqlString.Constant<open>(Open);

		public class closed() : PX.Data.BQL.BqlString.Constant<closed>(Closed);

		public class pendingPrint() : PX.Data.BQL.BqlString.Constant<pendingPrint>(PendingPrint);

		public class pendingEmail() : PX.Data.BQL.BqlString.Constant<pendingEmail>(PendingEmail);

		public class cCHold() : PX.Data.BQL.BqlString.Constant<cCHold>(CCHold);

		public class creditHold() : PX.Data.BQL.BqlString.Constant<creditHold>(CreditHold);

		public class reserved() : PX.Data.BQL.BqlString.Constant<reserved>(Reserved);
		public class pendingApproval() : PX.Data.BQL.BqlString.Constant<pendingApproval>(PendingApproval);
		public class rejected() : PX.Data.BQL.BqlString.Constant<rejected>(Rejected);
		public class canceled() : PX.Data.BQL.BqlString.Constant<canceled>(Canceled);
		public class HoldToBalance() : PX.Data.BQL.BqlString.Constant<HoldToBalance>("H->B");
		public class pendingPayment() : PX.Data.BQL.BqlString.Constant<pendingPayment>(PendingPayment);
		public class unapplied() : PX.Data.BQL.BqlString.Constant<unapplied>(Unapplied);
	}

	public class labelBalance() : Data.BQL.BqlString.Constant<labelBalance>(Messages.LabelBalance);

	public class labelUnpaidBalance() : Data.BQL.BqlString.Constant<labelUnpaidBalance>(Messages.LabelUnpaidBalance);	

	/// <summary>
	/// The base class for all accounts receivable documents, which
	/// provides the fields common to documents of <see cref="ARInvoice"/>,
	/// <see cref="ARPayment"/>, and <see cref="ARCashSaleEntry"/> types.
	/// </summary>
	...
	public partial class ARRegister : PXBqlTable, PX.Data.IBqlTable, IRegister, IAssign, IBalance, IDocumentKey, INotable
	{
		#region Events
		public class Events : PXEntityEvent<ARRegister>.Container<Events>
		{
			public PXEntityEvent<ARRegister, GL.Schedule> ConfirmSchedule;
			public PXEntityEvent<ARRegister, GL.Schedule> VoidSchedule;
		}
		#endregion
		#region Keys
		/// <exclude/>
		...
		public static class FK
		{
			...
			public class CustomerLocation : CR.Location.PK.ForeignKeyOf<ARRegister>.By<customerID, customerLocationID> { }
			...
			public class Schedule : GL.Schedule.PK.ForeignKeyOf<ARRegister>.By<scheduleID> { }
			public class RetainageAccount : GL.Account.PK.ForeignKeyOf<ARRegister>.By<retainageAcctID> { }
			public class RetainageSubaccount : GL.Sub.PK.ForeignKeyOf<ARRegister>.By<retainageSubID> { }
			public class OriginalDocument : AR.ARRegister.PK.ForeignKeyOf<ARRegister>.By<origDocType, origRefNbr> { }
		}
		#endregion
		...
		#endregion
		#region DocumentKey
		public abstract class documentKey : BqlString.Field<documentKey> { }

		[PXString(50, IsUnicode = true)]
		[PXUIField(DisplayName = "Document Description", Visibility = PXUIVisibility.Visible, Visible = false)]
		[PXDBCalced(typeof(docType.Concat<Space>.Concat<refNbr>), typeof(string))]
		[DocumentKey(typeof(ARDocType.ListAttribute))]
		...
		/// </value>
		[LocationActive(typeof(Where<Location.bAccountID, Equal<Optional<ARRegister.customerID>>,
		...
		#endregion
		#region PrepaymentAccountID
		public abstract class prepaymentAccountID : PX.Data.BQL.BqlInt.Field<prepaymentAccountID> { }
		/// <summary>
		/// The identifier of the <see cref="Account">account</see> to which the Tax and Taxable amounts
		/// should be posted when the feature <see cref="FeaturesSet.VATRecognitionOnPrepaymentsAR"/> is activated.
		/// The Cash account and Year-to-Date Net Income account cannot be selected as the value of this field.
		/// </summary>
		/// <value>
		/// Corresponds to the <see cref="Account.AccountID"/> field.
		...
		/// <summary>
		/// The identifier of the <see cref="Sub">subaccount</see> to which the Tax and Taxable amounts
		/// should be posted when the feature <see cref="FeaturesSet.VATRecognitionOnPrepaymentsAR"/> is activated.
		/// </summary>
		/// <value>
		/// Corresponds to the <see cref="Sub.SubID"/> field.
		/// </value>
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		[SubAccount(typeof(ARRegister.prepaymentAccountID), DescriptionField = typeof(Sub.description), DisplayName = "Prepayment Subaccount", Visibility = PXUIVisibility.Visible)]
		...
		[PXDBCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.origDocAmt), SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		...
		/// </summary>
		[PXDBBaseCury(typeof(branchID), SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		/// </summary>
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.docBal), BaseCalc=false, SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		[DynamicLabel(typeof(
			   labelUnpaidBalance.When<ARRegister.docType.IsEqual<ARDocType.prepaymentInvoice>
					   .And<ARRegister.status.IsNotEqual<ARDocStatus.unapplied>>
					   .And<ARRegister.status.IsNotEqual<ARDocStatus.closed>>
					   .And<ARRegister.status.IsNotEqual<ARDocStatus.voided>>
					   .And<ARRegister.status.IsNotEqual<ARDocStatus.reserved>>
			   >
			   .Else<labelBalance>
		))]
		...
		/// </summary>
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.initDocBal), SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		[PXUIField(DisplayName = "Balance", Visibility = PXUIVisibility.SelectorVisible, Enabled = false)]
		...
		/// Given in the <see cref="Company.BaseCuryID">base currency of the company</see>.
		/// </summary>
		[PXDBBaseCury(SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		/// </summary>
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXDBCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.origDiscAmt), SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		...
		#endregion
		#region Scheduled
		public abstract class fromSchedule : BqlBool.Field<fromSchedule> { }
		...
		public virtual bool? FromSchedule
		{
			get;
			set;
		}
		...
		public virtual Boolean? Payable
		{
			...
			get
			{
				return this._DocType == ARDocType.PrepaymentInvoice
					? this.PendingPayment == true
					: ARDocType.Payable(this._DocType);
			}
			set
			{
			}
		...
		public virtual Boolean? Paying
		{
			...
			get
			{
				return this._DocType == ARDocType.PrepaymentInvoice
					? this.PendingPayment != true
					: ARDocType.Payable(this._DocType) == false;
			}
			set
			{
			}
		...
		[PXDBCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.retainageTotal), SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		...
		[PXDBCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.retainageUnreleasedAmt), SignCondition = typeof(ARDocType.PositiveAmountTypes.Contains<docType>))]
		...
		[PXUIField(DisplayName = "Paid/Adjusted Retainage", FieldClass = nameof(FeaturesSet.Retainage))]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		...
		/// when the feature <see cref="FeaturesSet.VATRecognitionOnPrepaymentsAR"/> is activated.
		/// </summary>
		[PXDBBool]
		[PXDefault(false)]
		...
		#region PostponePendingPaymentFlag
		public abstract class postponePendingPaymentFlag : Data.BQL.BqlBool.Field<postponePendingPaymentFlag> { }

		/// <summary>
		/// Indicates that events will be invoke in the ARDocumentRelease.ProcessPostponedFlags() method
		/// for <see cref="pendingPayment"/> field.
		...
		public virtual bool? PrintInvoice
		{
			...
			get
			{
				return DontPrint != true && (Printed == null || Printed == false);
			}
		}
		#endregion
		#region EmailInvoice
		...
		public virtual bool? EmailInvoice
		{
			...
			get
			{
				return DontEmail != true && (Emailed == null || Emailed == false);
			}
		}
		#endregion
            ...
            protected virtual void StatusSet(PXCache cache, ARRegister item, bool? holdVal)
            {
				...
				if (item.Released != true)
                {
					...
					else
					{
						...
						else if(item.PendingProcessing == false)
						{
	...
	public partial class ARRegisterReport : ARRegister
	{
		#region Keys
		/// <exclude/>
		public new class PK : PrimaryKeyOf<ARRegisterReport>.By<docType, refNbr>
		{
			public static ARRegisterReport Find(PXGraph graph, string docType, string refNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, options);
		}
		public new static class FK
		{
			public class OriginalDocument : AR.ARRegister.PK.ForeignKeyOf<ARRegisterReport>.By<origDocType, origRefNbr> { }
		}
		#endregion
		...
		/// <inheritdoc cref="ARRegister.RefNbr"/>
		[PXDBString(15, IsUnicode = true, IsKey = true, InputMask = "")]
		[PXDefault]
		[PXUIField(DisplayName = "Reference Nbr.", Visibility = PXUIVisibility.SelectorVisible, TabOrder = 1)]
		[PXSelector(typeof(Search<ARRegisterReport.refNbr, Where<ARRegisterReport.docType, Equal<Optional<ARRegisterReport.docType>>>>), Filterable = true)]
		...
		public new abstract class isRetainageReversing : PX.Data.BQL.BqlBool.Field<isRetainageReversing> { }
		...
		[PXDependsOnFields(typeof(docType))]
		[PXFormula(typeof(
				Case<Where<ARRegister.docType.IsIn<ARDocType.refund, ARDocType.voidRefund, ARDocType.invoice, ARDocType.prepaymentInvoice, ARDocType.debitMemo, ARDocType.finCharge, ARDocType.smallCreditWO>>, decimal1,
		...
		[PXDependsOnFields(typeof(docType))]
		[PXFormula(typeof(
				Case<Where<ARRegister.docType.IsIn<ARDocType.refund, ARDocType.voidRefund, ARDocType.invoice, ARDocType.prepaymentInvoice, ARDocType.debitMemo, ARDocType.finCharge, ARDocType.smallCreditWO, ARDocType.cashSale>>, decimal1,
		...
		[PXDBCalced(typeof(
			Mult<
				...
				Case<Where<ARRegisterReport.isRetainageDocument.IsEqual<True>>,
					ARRegisterReport.origDocAmt,
				Case<Where<ARRegisterReport.isRetainageDocument.IsNotEqual<True>.And<ARRegisterReport.isRetainageReversing.IsEqual<True>>>,
					Mult<decimal_1, ARRegisterReport.retainageTotal>>>>
		), typeof(Decimal))]
	...
	public partial class ARAdjustedBalanceAtDate : PXBqlTable, IBqlTable
	{
		public abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
	...
	public partial class ARAdjustingBalanceAtDate : PXBqlTable, IBqlTable
	{
		public abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
		...
		SelectFrom<ARRegister>.
			...
			LeftJoin<ARRegisterReport>.
				On<ARRegister.docType.IsEqual<ARRegisterReport.origDocType>.
					...
					And<ARRegisterReport.isRetainageDocument.IsEqual<True>.Or<ARRegisterReport.isRetainageReversing.IsEqual<True>>>
				>.
		AggregateTo<
			GroupBy<ARRegister.docType>,
			GroupBy<ARRegister.refNbr>,
	...
	public partial class ARInvoiceRetainageBalanceAtDate : PXBqlTable, IBqlTable
	{
		public abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
	...
	[Serializable]
	[ARRegisterCacheName(Messages.ARDocument)]
	public partial class ARRegisterSigned : ARRegister
	{
		public new abstract class docType : PX.Data.BQL.BqlString.Field<docType> { }
		public new abstract class refNbr : PX.Data.BQL.BqlString.Field<refNbr> { }
		public new abstract class origDocAmt : PX.Data.BQL.BqlDecimal.Field<origDocAmt> { }
		...
		{ get; set; }
		#endregion
		#region signedOrigDocAmt
		public abstract class signedOrigDocAmt : PX.Data.BQL.BqlDecimal.Field<signedOrigDocAmt> { }
		[PXDecimal(4)]
		[PXDBCalced(typeof(
			Mult<
	...
	[PXProjection(typeof(
		SelectFrom<ARRegisterSigned>.
		Where<ARRegisterSigned.released.IsEqual<True>.
			And<ARRegisterSigned.docType.IsEqual<ARDocType.cashSale>.Or<ARRegisterSigned.docType.IsEqual<ARDocType.cashReturn>>>>.
		AggregateTo<
			GroupBy<ARRegisterSigned.finPeriodID>,
	...
	[Serializable]
	public partial class ARRegisterAR622000 : PXBqlTable, IBqlTable
	{
		#region RefNbr
	...
	[Serializable]
	public partial class ARRegisterAR610500 : PXBqlTable, IBqlTable
	{
		#region RefNbr
		[PXSelector(typeof(Search2<ARRegister.refNbr,
			InnerJoinSingleTable<Customer, On<ARRegister.customerID, Equal<Customer.bAccountID>>>,
	...
	[PXHidden]
	[PXProjection(typeof(SelectFrom<ARRegisterReport>
	.InnerJoin<ARTran>
		.On<ARRegisterReport.docType.IsEqual<ARTran.tranType>
		.And<ARRegisterReport.refNbr.IsEqual<ARTran.refNbr>>>
	.Where<ARRegisterReport.isRetainageDocument.IsEqual<True>
		.And<ARRegisterReport.status.IsNotEqual<ARDocStatus.closed>
		.And<ARTran.origRefNbr.IsNotNull>>>
	.Aggregate<To<
		GroupBy<ARTran.origDocType,
		GroupBy<ARTran.origRefNbr>>>>))]
	public class OriginalRetainageDocumentsWithOpenBalance : PXBqlTable, IBqlTable
	{
		#region OrigDocType
		public abstract class origDocType : PX.Data.BQL.BqlString.Field<origDocType> { }
